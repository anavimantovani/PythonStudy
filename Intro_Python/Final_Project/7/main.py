...
# Loop back to the menu until the user selects '6. Exit'
while True:
    ...
    # Save the current database to a file
        ...
        filename = input("Enter the filename to save the database: ")
        book_database.save(filename)
        print("Database saved to", filename)
        print()

    # Load a saved database from a file
    elif user_choice == 5:
        filename = input("Enter the filename to load the database from: ")
        book_database.load(filename)
        print("Database loaded from", filename)
        print()
